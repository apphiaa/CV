...
/* harmony import */ var _static_images_NotFound_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @static/images/NotFound.png */ "./static/images/NotFound.png");
/* harmony import */ var _static_images_NotFound_png__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_static_images_NotFound_png__WEBPACK_IMPORTED_MODULE_0__);
...
var Img = {
  OnError: function OnError(_ref) {
    var img = _ref.target;
    img.onerror = null;
    img.src = _static_images_NotFound_png__WEBPACK_IMPORTED_MODULE_0___default.a;
  },
...
var useInfiniteScroll = function useInfiniteScroll(callback) {
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(false),
      ...
      setIsFetching = _useState2[1]; // 是否還有更多
  ...
  var handleScroll = function handleScroll() {
    var currentScrollY = Math.max(window.pageYOffset, document.documentElement.scrollTop, document.body.scrollTop);
...
/* harmony import */ var _components_presentational_Image__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @components/presentational/Image */ "./components/presentational/Image.js");
/* harmony import */ var _utils_hooks_useInfiniteScroll__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @utils/hooks/useInfiniteScroll */ "./assets/utils/hooks/useInfiniteScroll.js");
/* harmony import */ var _sass_components_portfolio_module_scss__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @sass/components/portfolio.module.scss */ "./assets/sass/components/portfolio.module.scss");
/* harmony import */ var _sass_components_portfolio_module_scss__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_sass_components_portfolio_module_scss__WEBPACK_IMPORTED_MODULE_9__);
...
var ARRAY_SIZE = 20;
var Portfolio = Object(react__WEBPACK_IMPORTED_MODULE_3__["memo"])(function (_ref) {
  var data = _ref.data;
  console.log('render Portfolio'); // 顯示的物件

  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])([]),
      _useState2 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_useState, 2),
      listItems = _useState2[0],
      setListItems = _useState2[1]; // 全部的物件


  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])(data),
      _useState4 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_useState3, 2),
      filterData = _useState4[0],
      setFilterData = _useState4[1]; // 載入中


  var _useInfiniteScroll = Object(_utils_hooks_useInfiniteScroll__WEBPACK_IMPORTED_MODULE_8__["default"])(fetchMoreListItems),
      _useInfiniteScroll2 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_useInfiniteScroll, 4),
      isFetching = _useInfiniteScroll2[0],
      setIsFetching = _useInfiniteScroll2[1],
      hasMore = _useInfiniteScroll2[2],
      setHasMore = _useInfiniteScroll2[3];

  function fetchMoreListItems() {
    console.log('-fetchMoreListItems-', listItems.length, filterData.length, hasMore, isFetching);
    setListItems(function (prevItems) {
      return [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(prevItems), Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(filterData.slice(prevItems.length, prevItems.length + ARRAY_SIZE)));
    });
  } // 資料更新時 同步更新 是否還有更多
  ...
  var _gridRef = Object(react__WEBPACK_IMPORTED_MODULE_3__["useRef"])(); // 更新格子布局


  function handleGridUpdate() {
    _gridRef.current.updateLayout();
  } // 目前分類


  var categoryRef = Object(react__WEBPACK_IMPORTED_MODULE_3__["useRef"])(null); // 篩選物件

  var handleFilter = function handleFilter(_category) {
    console.log('-handleFilter', hasMore, isFetching);
    if (categoryRef.current === _category) return;
    categoryRef.current = _category;

    if (categoryRef.current) {
      setFilterData(data.filter(function (_data) {
  ...
  var COLUMN_WIDTH = document.body.clientWidth > 480 ? 200 : 150;
  return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
  ...
  }, [categoryRef.current]), Object(react__WEBPACK_IMPORTED_MODULE_3__["useMemo"])(function () {
    return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(react_stack_grid__WEBPACK_IMPORTED_MODULE_4___default.a, {
      columnWidth: COLUMN_WIDTH,
      monitorImagesLoaded: false,
      gridRef: function gridRef(grid) {
        return _gridRef.current = grid;
      },
      __source: {
        fileName: _jsxFileName,
        lineNumber: 116
      ...
      return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(Box, {
        key: index,
        item: item,
        columnWidth: COLUMN_WIDTH
  ...
  }, [listItems]), react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
    className: _sass_components_portfolio_module_scss__WEBPACK_IMPORTED_MODULE_9___default.a.tips,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 124
    },
    __self: this
  }, hasMore && isFetching && react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("span", {
    className: _sass_components_portfolio_module_scss__WEBPACK_IMPORTED_MODULE_9___default.a.loading,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 125
    },
    __self: this
  }), hasMore && !isFetching && react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("button", {
    type: "button",
    className: _sass_components_portfolio_module_scss__WEBPACK_IMPORTED_MODULE_9___default.a.more,
    onClick: handleLoad,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 127
    ...
    __self: this
  }, react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(react_icons_md__WEBPACK_IMPORTED_MODULE_6__["MdExpandMore"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 128
    },
    __self: this
  }))), !hasMore && react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
    className: _sass_components_portfolio_module_scss__WEBPACK_IMPORTED_MODULE_9___default.a.done,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 132
    },
...
var Nav = function Nav(_ref2) {
  var handleFilter = _ref2.handleFilter,
  ...
  return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("ul", {
    className: _sass_components_portfolio_module_scss__WEBPACK_IMPORTED_MODULE_9___default.a.nav,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 145
    },
    ...
    return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("li", {
      key: category.id,
      role: "menuitem",
      className: classnames__WEBPACK_IMPORTED_MODULE_5___default()(Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, _sass_components_portfolio_module_scss__WEBPACK_IMPORTED_MODULE_9___default.a.active, categoryRef.current === category.value)),
      onClick: function onClick() {
        return handleFilter(category.value);
      },
...
var Box = function Box(_ref3) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
    className: _sass_components_portfolio_module_scss__WEBPACK_IMPORTED_MODULE_9___default.a.box,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 163
    },
    ...
    __self: this
  }, react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_components_presentational_Image__WEBPACK_IMPORTED_MODULE_7__["default"], {
    src: item.src,
    alt: item.name,
    style: {
    ...
    className: _sass_components_portfolio_module_scss__WEBPACK_IMPORTED_MODULE_9___default.a.mask,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 166
    },
    __self: this
  }, item.category && react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
    className: _sass_components_portfolio_module_scss__WEBPACK_IMPORTED_MODULE_9___default.a.category,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 168
    },
  ...
  })), item.description && react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("figcaption", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 174
    },
  ...
  switch (dir) {
    case 'images':
      return progressive ? react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_lazy_progressive_image__WEBPACK_IMPORTED_MODULE_3___default.a, {
        ...
        onError: _utils_common_Image__WEBPACK_IMPORTED_MODULE_6__["Img"].OnError,
...
var TempImage = function TempImage(props) {
  ...
  var handleOnLoad = function handleOnLoad(e) {
    if (onLoad) onLoad();
    if (defaultOnLoad) _utils_common_Image__WEBPACK_IMPORTED_MODULE_6__["Img"].onLoad(e);
  };
...
var map = {
	...
	"./js/rem": "./static/js/rem.js",
	"./js/rem.js": "./static/js/rem.js",
	"./js/user-agent": "./static/js/user-agent.js",
	"./js/user-agent.js": "./static/js/user-agent.js",
...
module.exports = JSON.parse("[{\"id\":10,\"name\":\"旅遊\",\"desc\":\"\",\"icon\":\"images/hobbies/plane.png\"},{\"id\":20,\"name\":\"唱歌\",\"desc\":\"\",\"icon\":\"images/hobbies/hand.png\"},{\"id\":30,\"name\":\"電影\",\"desc\":\"\",\"icon\":\"images/hobbies/film.png\"}]");
...
module.exports = JSON.parse("{\"avatar\":\"images/personal/avatar.png\",\"name\":\"江聿臻\",\"introduction\":\"1996.1.29\"}");
...
module.exports = JSON.parse("[{\"id\":10,\"name\":\"AI\",\"percentage\":60},{\"id\":20,\"name\":\"AE\",\"percentage\":50},{\"id\":30,\"name\":\"PS\",\"percentage\":90},{\"id\":40,\"name\":\"3D\",\"percentage\":30}]");
...
module.exports = "/_next/static/images/favicon-63f0e03be5868bf799dd63ae965f83f6.ico";
...
(function (doc, win) {
  ...
  var recalc = function recalc() {
    var width = docEl.clientWidth; // 大于1280按1280来算
    ...
    doc.body && doc.body.style.height !== docEl.clientHeight && docEl.clientHeight > 360 && (doc.body.style.height = docEl.clientHeight + 'px');
  };
...
(function () {
  // 判断移动PC端浏览器和微信端浏览器
  var ua = navigator.userAgent; // var ipad = ua.match(/(iPad).* OS\s([\d _] +)/);
